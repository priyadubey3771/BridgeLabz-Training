...
public class StudentGradeCalculation {
 public static void main (String[] args){
	Scanner input = new Scanner(System.in);
        ...
        //Declaring and taking input array marks and percentage as input
        ...
        for (int i = 0; i < n; i++)
        {
            System.out.println("Student " + (i + 1) +" Physics: " + marks[i][0] +" Chemistry: " + marks[i][1] +" Maths: " + marks[i][2] +" Percentage: " 
